  ...
  return (
    <AppLayout>
      <div dir="rtl" className="min-h-screen bg-[#F5F6FA] overflow-x-hidden">
        ...
        {/* ══════════════════════════════════════════════════════════════
            SECTION 4 — THE 12 DIMENSIONS
        ══════════════════════════════════════════════════════════════ */}
        <section className="max-w-6xl mx-auto px-6 py-20">
          <Section>
            <SectionHeader
              badge="القسم الثالث"
              titleAr="الأبعاد الاثنا عشر لنظرية الشامسي"
              subtitleAr="كل بُعد يمثل محوراً مستقلاً من محاور تقييم المشروعية، ويخضع لمنهجية قياس خاصة تنتج درجة تدخل في الحساب النهائي لمؤشر ASLI."
            />
          </Section>
          ...
          <Section className="mt-6">
            <div className="bg-[#1B2A4A]/5 border border-[#1B2A4A]/10 rounded-xl px-6 py-4 text-center text-sm text-muted-foreground">
              💡 انقر على أي بُعد لعرض معايير تقييمه التفصيلية. تُوزَّع الدرجة الكلية مئة نقطة وفق أوزان مرجَّحة تراعي طبيعة القرار.
            </div>
          </Section>
        </section>
