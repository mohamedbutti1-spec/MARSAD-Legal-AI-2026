...
- [Phase 60 — ADKG 16-Pillar Analyzer](phase60-adkg-pillar-analyzer.md) — 16 pillars in 2 groups (6 traditional/10 AI); pillarAnalysis stored in metadata (not citedAuthorities); buildAdkgEvaluatorPrompt is ADKG-only
